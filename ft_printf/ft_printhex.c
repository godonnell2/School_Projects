...
/*   Updated: 2024/11/12 19:08:43 by gro-donn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// For other values, it calls ft_printhex_recursive to handle the recursive printing of hexadecimal digits.
// ft_printhex_recursive recursively divides nbr by 16, printing each digit in hexadecimal using ft_printhex_digit.

// ft_printhex_digit prints a single hexadecimal digit using ft_putchar_fd.

// Example of Usage
// Calling ft_printhex(1, 255, fd):
// Since nbr is not 0, ft_printhex_recursive will recursively convert 255 to hexadecimal, printing "FF" if big is 1, or "ff" if big is 0.

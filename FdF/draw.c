...
/*   Updated: 2025/01/25 07:14:27 by gro-donn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fdf.h"

static void	my_mlx_pixel_put(t_data *t_data_pix, int x, int y, int color)
{
	char	*dst;
...
void	draw_line(t_data *t_data_pix, t_line *line)
{
	...
	while (1)
	{
		my_mlx_pixel_put(t_data_pix, line->x0, line->y0, line->color);
